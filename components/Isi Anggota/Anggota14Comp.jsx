...
import {DataAnggota14} from "./DataAnggota14";
import {BsChevronDown} from "react-icons/bs";

export function AnggotaComp() {
  return (
      ...
      <div className="max-w-5xl pt-40 mb-20">
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            ...
            Angaktan <span className="text-blue-700">14</span>{" "}
          ...
          <ul
            ...
            {DataAnggota14.map((person, id) => (
              <li key={id}>
                <div className="relative overflow-hidden">
                  <input
                    type="checkbox"
                    className="peer absolute top-0 inset-x-0 w-full h-20 opacity-0 cursor-pointer"
                  />
